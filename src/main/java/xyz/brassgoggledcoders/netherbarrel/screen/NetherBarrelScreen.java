package xyz.brassgoggledcoders.netherbarrel.screen;
...
public class NetherBarrelScreen extends AbstractContainerScreen<NetherBarrelMenu> {
    private static final ResourceLocation CONTAINER_BACKGROUND = new ResourceLocation("textures/gui/container/generic_54.png");

    private final int containerRows;

    public NetherBarrelScreen(NetherBarrelMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
